...
<head>
    ...
    <title>Manage Donation - Blood Bank</title>
...
<body>
            ...
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown pe-3">
                    ...
                    <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                        <img src="<?= "upload/{$_SESSION["user_img"]}";?>" alt="Profile" class="rounded-circle">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                        ...
                        <li>
                            <a class="dropdown-item d-flex align-items-center" href="blood_bank_profile.php">
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link " href="blood_bank_dashboard.php">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="blood_bank_profile.php">
                    <i class="bi bi-person"></i>
                    <span>Profile</span>
                </a>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <!-- Small tables -->
                            <table class="table table-hover datatable" id="today_donation_table"
                                ...
                                <tbody>
                                    <?php
                                        $donation_response = $conn->query("SELECT * FROM donation INNER JOIN donar_registration ON donation.donar_id = donar_registration.donar_id INNER JOIN blood_group ON donation.blood_group = blood_group.blood_group_id WHERE donation.request_status = 'accept' ORDER BY donation.donation_id DESC");
                                        // donation id
                                      
                                        if($donation_response->num_rows > 0){
                                        $t = 1;
                                    ...
                                    <tr class="text-center">
                                        <td scope="row"><input type="checkbox"
                                                value="<?= "{$donation_row['donation_id']}"?>"
                                                name="row_donation_status[]"></td>
                                        <td scope="row"><?= $t; ?></td>
                                        <td><?= $donation_row['donar_name'] ?></td>
                                        <td><?= $donation_row['donar_mobile']; ?></td>
                                        <td><?= $donation_row['donar_gender']; ?></td>
                                        <td><?= $donation_row['blood_group_name'] ?></td>
                                        <td><?= $donation_row['no_unit'] ?></td>
                                        <td><?= $donation_row['disease'] ?></td>
                                        <td>
                                            <span
                                                class="badge rounded-pill bg-dark"><?= $donation_row['request_status'] ?>
                                            </span>

                                        </td>
                                        <td>
                                            <a href="view_request.php?id=<?php echo "{$donation_row['donation_id']}"?>"
