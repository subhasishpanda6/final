...
<body>
    ...
    <main>
        ...
        if (isset($_POST['login'])) { 
            ...
            // to get all data occording to email id
            $sql = $conn->prepare("SELECT * FROM blood_bank_registration WHERE email=?");
            ...
            if ($result->num_rows > 0){
                ...
                if($password === $row['password']){
                    ...
                    $_SESSION['user_type'] = 'blood_bank';
                    $_SESSION["user_id"] = $row['blood_bank_id'];
                    $_SESSION["user_name"] = $row['blood_bank_name'];
