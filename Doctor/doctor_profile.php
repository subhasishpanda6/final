...
$row1=mysqli_query($conn,"select *from doctor_registration where id='$doc_id' ");
						...
						<ul class="main-nav">
							...
							<li class="has-submenu active">
								...
								<ul class="submenu">
									...
									<li class="active"><a href="doctor-profile-settings.html">Profile Settings</a></li>
				...
				<div class="container-fluid">
					...
					<div class="row">
								...
								<div class="widget-profile pro-widget-content">
									<div class="profile-info-widget">
										...
										<div class="profile-det-info">
											<h3><?=$_SESSION['sess_user'];?></h3>
										
											<div class="patient-details">
												<h5 class="mb-0"><?=$_SESSION['doctor_name'];?></h5>
						...
						<div class="col-md-7 col-lg-8 col-xl-9">
							...
							<div class="card">
								<div class="card-body">
									<h4 class="card-title">Doctor Profile Details</h4>
									<div class="row form-row">
										<div class="col-md-12">
											...
											?>
													...
													<div class="upload-img" style="line-height: 1.2;">
														...
														<button type="submit" name="upload" style="position: relative;  border-radius: 50px; color: white; background-color:#20c0f3; width:150px ;padding: 10px 2px;text-align: center;font-size: 13px; height:35px;
                                                            font-weight: 550;cursor: pointer; box-sizing: border-box; border-color: transparent;">Submit</button>
													</div>
												</form>
												</div>
											</div>
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text" value="<?php echo $row2["name"]?>" class="form-control" readonly>
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="email" value="<?php echo $row2["email"]?>" class="form-control" readonly>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<label>Department<span class="text-danger">*</span></label>
												<input type="text" value="<?php echo $row2["department"]?>" class="form-control" readonly>
											</div>
										</div>
										...
										<div class="col-md-6">
											<div class="form-group">
												<label>Gender</label>
												<input type="text" value="<?php echo $row2["gender"]?>" class="form-control" readonly>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<label>Education</label>
												<input type="text" class="form-control" value="<?php echo $row2["education"]?>" readonly>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group mb-0">
												<label>Address</label>
												<input type="text" class="form-control" value="<?php echo $row2["address"]?>" readonly>
											</div>
										</div>
										...
										<div class="col-md-6">
											<div class="form-group mb-0">
												<label>City</label>
												<input type="text" class="form-control" value="<?php echo $row2["city"]?>"readonly>
											</div>
										</div>
											...
											<div class="form-group mb-0">
												<label>Pincode</label>
												<input type="text" class="form-control" value="<?php echo $row2["pincode"]?>"readonly>
											</div>
									</div>
									...
									<div class="col-md-6">
											<div class="form-group mb-0">
												...
												<input type="text" class="form-control" value="<?php echo $row2["joining_date"]?>" readonly>
											</div>
								</div>
								           <div class="col-md-6">
											<div class="form-group mb-0">
												...
												<input type="text" class="form-control" value="<?php echo $row2["phone_no"]?>" readonly>
											</div>
								</div>
								           <div class="col-md-6">
											<div class="form-group mb-0">
												...
												<input type="text" class="form-control" value="<?php echo $row2["reg_no"]?>" readonly>
											</div>
								</div>
								            <div class="col-md-6">
											<div class="form-group mb-0">
												<BR>
												<label>Fees</label>
												<input type="text" class="form-control" value="<?php echo $row2["fees"]?>" readonly>
											</div>
								</div>
								<div class="col-md-6">
											<div class="form-group mb-0">
