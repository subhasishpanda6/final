            ...
            <div class="col-lg-12">
                ...
                if(isset($_POST['register'])){
                    if(!empty($_POST['donar_name']) &&  !empty($_POST['gender']) && !empty($_POST['donar_dob']) && !empty($_POST['donar_location']) && !empty($_POST['donar_pincode']) && !empty($_POST['donar_blood_group']) && !empty($_POST['donar_address'])){
                        ...
                        $register_donar = $conn->prepare("INSERT INTO donar SET register_id = ?, donar_name = ?,donar_email=?,donar_gender=?,donar_dob=?,donar_location=?,donar_phone=?,donar_pincode=?,donar_address=?,donar_blood_group=?");
                        $register_donar->bind_param("isssssssss",$_SESSION['patient_id'],$_POST['donar_name'],$_POST['donar_email'],$_POST['gender'],$_POST['donar_dob'],$_POST['donar_location'],$_POST['donar_phone'],$_POST['donar_pincode'],$_POST['donar_address'],$blood_gr_name);
