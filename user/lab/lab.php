      ...
      ?>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
           <button type="button" class="btn btn-danger" data-dismiss="modal">Checkout</button>
        </div>
				...
				<div class="container-fluid">
					<div class="row align-items-center">
						<div class="col-md-12 col-12">
							...
							<button style="position: absolute;bottom: 8px;right: 16px;" type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">
 								View Cart
						</div>
					</div>
				</div>
				...
				<div class="container-fluid">
					...
					<div class="row">
						...
						<?php 
                         ...
                         $sql = "SELECT * FROM lab_registration";
							...
							<div class="appointments">
								...
								<div class="appointment-list">
									<div class="profile-info-widget">
										...
										<div class="profile-det-info">
											<h3><a href="patient-profile.html"><?php echo $row["lab_name"]; ?></a></h3>
											<div class="patient-details">
												
										<h5><i class="fas fa-map-marker-alt"></i><?php echo $row["address"]; ?></h5>
												<h5><i class="fas fa-envelope"></i><?php echo $row["email"]; ?></h5>
												<h5 class="mb-0"><i class="fas fa-phone"></i>phone no</h5>
											</div>
										</div>
									</div>
									<div class="appointment-action">
										<a href="lab_test.php?lab_id=<?php echo $row["lab_id"]; ?>" class="btn btn-sm bg-info-light" >
