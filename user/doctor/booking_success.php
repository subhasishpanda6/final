							...
							<div class="card success-card">
								<div class="card-body">
									<div class="success-cont">
										...
										<p>Appointment booked with <strong><?php echo $row4["doc_name"];?></strong><br> on <strong><?php echo $row4["booking_date"];?></strong> at  <strong> <?php echo $row4["booking_time"];?></strong></p>
										<a href="../../index.php" class="btn btn-primary view-inv-btn">Go to Home</a>
									</div>
								</div>
							</div>
							<!-- /Success Card -->
