                ...
                <div class="card">
                    <div class="card-body pt-0">
                        ...
                        <div class="tab-content pt-0">
                            <!-- need_blood Tab -->
                            <div id="need_blood" class="tab-pane fade show active">
                                                   ...
                                                   <?php while($row3 = $query1->fetch_assoc()){ ?>
                                                    <tr>
                                                        ...
                                                        <td > 
                                                            ...
                                                            }else if($row3['request_status'] === "cancel" || $row3['request_status'] === "rejected"){
                                                ...
                                                <tbody>
                                                   <?php while($row6 = $query5->fetch_assoc()){ ?>
                                                    <tr>
                                                        ...
                                                        <td><?= $row6['blood_group']; ?></td>
                                                        <td><?= $row6['no_of_unit']; ?></td>
