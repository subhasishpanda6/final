...
<body>
  ...
  if (isset($_POST['submit'])) {    
    $sql = $conn->prepare("UPDATE blood_bank_registration SET  blood_bank_name=? , email=?,password=?,address=?,city=?,pincode=?,joining_date=?  WHERE blood_bank_id = ?");
    ...
    $sql->bind_param("sssssssi",$blood_bank_name, $email,$password,$address,$city,$pincode,$joining_date,$_GET["id"]);  
    if($sql->execute()) {
  ...
  $sql = $conn->prepare("SELECT * FROM blood_bank_registration WHERE blood_bank_id =?");
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control" name="blood_bank_name"
                                                value="<?php echo $row["blood_bank_name"]?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
