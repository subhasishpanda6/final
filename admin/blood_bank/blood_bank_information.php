            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li class="">
                            <a href="specialities.html"><i class="fe fe-users"></i> <span>Doctor</span></a>
                        </li>
                        <li class=" ">
                            <a href="lab_information.php"><i class="fe fe-users"></i> <span>Lab</span></a>
                        </li>
                        <li class="active">
                            <a href="blood_bank_information.php"><i class="fe fe-users"></i><span>Blood Bank</span></a>
                            <!--
							<li> 
                    ...
                    <div class="row">
                        <div class="col-sm-7 col-auto">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Edit Blood Bank</li>
                            </ul>
                        </div>
                        <div class="col-sm-5 col">
                            <a href="#Add_Specialities_details" data-toggle="modal"
                                class="btn btn-primary float-right mt-2">Add Blood Bank</a>
                        </div>
                    </div>
                </div>
                <!-- /Page Header -->
...
$sql = "SELECT * FROM blood_bank_registration";
                            ...
                            <div class="card-body">
         					 ...
         					 while($row = $result->fetch_assoc()) {?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo $row["blood_bank_id"]; ?>
                                                </td>
                                                <td>
                                                    <?php echo $row["blood_bank_name"]; ?>
                                                </td>
                                                <td>
                                                    <?php echo $row["email"]; ?>
                                                </td>
                                                ...
                                                <td>
                                                    <a href="blood_bank_edit.php?id=<?php echo $row["blood_bank_id"]; ?>"
                                                        class="btn btn-success">EDIT</a>
                                                    <a href="delete_blood_bank.php?id=<?php echo $row["blood_bank_id"]; ?>"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Blood Bank Registration</h5>
                            ...
                            <div class="row form-row">
                                <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="blood_bank_name">
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6">
                                    <div class="form-group">
