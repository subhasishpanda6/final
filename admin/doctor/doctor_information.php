         ...
         <span class="user-img"> <?php if(!$row['image'])
                          ...
                          <td>
                            <?php echo $row["joining_date"]; ?>
													...
													<td>
                         <a href="doctor_edit.php?id=<?php echo $row["id"]; ?>"  class="btn btn-success">EDIT</a>
                            <a href="delete_doctor.php?id=<?php echo $row["id"]; ?>"  class="btn btn-danger" onclick="return confirm('Are you sure you want to delete?')" >DELETE</a>
                          </td>
