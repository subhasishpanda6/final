...
<!-- Sidebar -->
  ...
  if (isset($_POST['submit'])) {    
    $sql = $conn->prepare("UPDATE doctor_registration SET  name=? , email=?,department=?,password=?,gender=?,education=?,address=?,city=?,pincode=?,joining_date=?  WHERE id=?");
    $name=$_POST['name'];
    $email = $_POST['email'];
    ...
    $sql->bind_param("ssssssssssi",$name, $email,$department,$password,$gender,$education,$address,$city,$pincode,$joining_date,$_GET["id"]);  
    if($sql->execute()) {
  ...
  $sql = $conn->prepare("SELECT * FROM doctor_registration WHERE id=?");
								...
								<div class="card-body">
									<form action="" method="post">
										...
										<div class="form-group row">
											...
											<div class="col-md-10">
												<input class="form-control" type="text" name="education" value="<?php echo $row["education"]?>">
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-md-10">
											<input class="form-control" type="text" name="pincode" value="<?php echo $row["pincode"]?>">
											</div>
										</div>
										<div class="form-group mb-0 row">
											<label class="col-form-label col-md-2">Joining Date</label>
											<div class="col-md-10">
												<input class="form-control" type="text" name="joining_date" value="<?php echo $row["joining_date"]?>">
												</div>
											</div>
