                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-5 col">
                            <a href="#Add_Specialities_details" data-toggle="modal"
                                class="btn btn-primary float-right mt-2">Add Lab</a>
                        </div>
                    </div>
                </div>
                <!-- /Page Header -->
                            ...
                            <div class="card-body">
         					 ...
         					 while($row = $result->fetch_assoc()) {?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="lab_edit.php?id=<?php echo $row["id"]; ?>"
                                                        class="btn btn-success">EDIT</a>
                                                    <a href="delete_lab.php?id=<?php echo $row["id"]; ?>"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Lab Registration</h5>
