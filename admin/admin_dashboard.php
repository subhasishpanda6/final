        ...
        <div class="main-wrapper">
                ...
                <div class="sidebar-inner slimscroll">
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li> 
								<a href="doctor/doctor_information.php"><i class="fe fe-users"></i> <span>Doctor</span></a>
							</li>
							<li> 
								<a href="blood_bank/blood_bank_information.php"><i class="fe fe-user-plus"></i> <span>Blood Bank</span></a>
							</li>
							<li> 
								<a href="patient/patient-list.php"><i class="fe fe-user"></i> <span>Patients</span></a>
							</li>
							<li> 
            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
					...
					<?php
					require_once("db.php");
$row1=mysqli_query($conn,"select * from doctor_registration  ");
$row2=mysqli_num_rows($row1);

$row3=mysqli_query($conn,"select * from patient_registration  ");
...
$sql1 = "SELECT * FROM patient_registration";
...
?>
         ...
         <span class="user-img"> <?php if(!$row['image'])
											echo "<img src='../Doctor/profile_pic/".'no_profile.png'."' class='rounded-circle' width='31'>";
											else	 echo "<img src='../Doctor/profile_pic/".$row["image"]."' class='rounded-circle' width='31' >"; ?> </span>
                           <?php echo $row["name"]; ?>
                          </td>
         ...
         <span class="user-img"> <?php if(!$row2['image'])
											echo "<img src='../patient/profile_pic/".'no_profile.png'."' class='rounded-circle' width='31'>";
											else	 echo "<img src='../patient/profile_pic/".$row2["image"]."' class='rounded-circle' width='31' >"; ?> </span>
                           <?php echo $row2["name"]; ?>
                          </td>
