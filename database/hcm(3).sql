...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 17, 2023 at 05:48 PM
...
INSERT INTO `admin` (`id`, `user`, `pass`, `dob`, `email`, `phone_no`, `city`, `state`, `pin_code`, `country`, `image`) VALUES
(1, 'mmmm', '456', '2004-04-01', 'mm@gmail.com', '454123', 'dfdv', 'wb', '711032', 'india', 'T1.jpg');
...
(0, 'A.Roy Group Blood Bank', 'Medplus@gmail.com', 'abc1237', 'kolkata ', 'Andul', '000188', '2023-03-11');
...
(1, 1, 5, '2023-03-15', 'A.R Group Blood Bank', 'B+', 'fgh', 'accept', '2023-03-16 12:13:52'),
(2, 2, 5, '2023-03-14', 'General Blood Bank', 'AB+', 'no', 'accept', '2023-03-18 04:26:35'),
...
INSERT INTO `category_list` (`id`, `name`, `description`, `status`, `last_update`) VALUES
(1, 'Arghya', 'hhhg\r\nnnj\r\nnhjj', 'Inactive', '2023-03-11'),
(2, 'Arghya Roy', '77777yyyyyyiiii', 'Active', '2023-03-02'),
(4, 'paracetamol', 'ppppppppppppppppppppppppppp', 'Inactive', '2023-03-13');
...
(13, 'ADITYA ROY ', 'adi@gmail.com', 'GYNOCOLOGIST', '123', 'Male', 'MD', 'SECTOR-V', 'KOLKATA', '781201', '2023-01-15', 'NO UPDATE', 'NO UPDATE', 'NO UPDATE', 'T5.jpg'),
...
(19, '', '', '', '', 'Select', '', '', '', '', '', 'NO UPDATE', 'NO UPDATE', 'NO UPDATE', '');
...
(1, 7, 'aditya', 'adi@gmail.com', 'female', '2022-03-03', 'howrah', '123', '700005', 'gfg', 'B+', '2023-03-16 01:27:43'),
(2, 5, 'ROHAN MAITI', 'rohan@gmail.com', 'male', '2023-03-29', 'howrah', '123', '711302', 'dfgf', 'AB+', '2023-03-16 08:44:34'),
...
--
-- Table structure for table `medicine_shop_registration`
--

CREATE TABLE `medicine_shop_registration` (
  `id` int(200) NOT NULL,
  `medicine_shop_name` varchar(200) NOT NULL,
  `email` varchar(200) NOT NULL,
  `password` varchar(200) NOT NULL,
...
--
-- Dumping data for table `medicine_shop_registration`
--

INSERT INTO `medicine_shop_registration` (`id`, `medicine_shop_name`, `email`, `password`, `address`, `city`, `pincode`, `joining_date`, `image`, `phone`) VALUES
(1, 'THE BLUE PRINT', 'abc@gmail.com', '123', 'Andul', 'Andul', '711302', '2023-01-22', 'Arghya Roy (20600119027) (22).jpg', '9000000069'),
(3, 'Medplus', 'Medplus@gmail.com', '123', 'Andul', 'Andul', '711302', '2023-01-25', 'med.jpg', '1323538777'),
(4, 'A Medicine Shop', 'ar@gmail.com', '1234', 'kolkata ', 'Kolkata', '700003', '2023-01-25', '', ''),
(5, 'Adi Medicine Shop', 'adi@gmail.com', '0101', 'kolkata ', 'Kolkata', '700003', '2023-01-17', 'priya.png', '8240577118');
...
(13, 2, 4, 1, 105, '2023-03-08', 'Mukundapur', '721442', 'Kushboni', 'for feaver', '2023-03-19 04:12:11', 'reject'),
(15, 2, 2, 1, 78, '2023-03-07', 'sdfdsf', 'sdfdf', 'dfs', 'sfd', '2023-03-19 04:12:02', 'accept'),
(16, 7, 1, 1, 4545, '2023-03-06', '45646', '4545', '4545', '454', '2023-03-19 04:12:15', 'cancel'),
(17, 7, 3, 2, 445, '2023-03-15', 'gjhgj', 'srf', 'sdfd', 'dsf', '2023-03-19 05:08:23', 'pending'),
(18, 7, 4, 2, 45, '2023-03-24', 'fgfh', 'sfds', 'dsds', 'sdf', '2023-03-19 04:45:21', 'accept'),
(19, 7, 5, 2, 10, '2023-03-14', 'chalti', '721442', 'saraswatiput', 'sdfds', '2023-03-19 05:57:48', 'accept'),
...
(7, 'aditya', 'adi@gmail.com', 'male', 0, '', '700005', '789', '123', '123', 'T2.jpg');
...
INSERT INTO `product_list` (`id`, `category_name`, `name`, `dose`, `image`, `brand`, `description`, `price`, `status`, `last_update`) VALUES
(2, 'Tablet', 'paracetamol', '650mg', 'para pic', 'Calpol', 'goood product', '45.90', 'Active', '13/03/2023'),
(4, 'Tablet', 'Azithromycin', '500mg', 'Azit pic', 'Zithromax', 'Azithromycin belongs to the class of drugs known as macrolide antibiotics. It works by killing bacteria or preventing their growth. However, this medicine will not work for colds, flu, or other virus ', '72.89', 'Active', '13/03/2023');
...
--
-- Indexes for table `medicine_shop_registration`
--
ALTER TABLE `medicine_shop_registration`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `medicine_shop_registration`
--
ALTER TABLE `medicine_shop_registration`
